			...
			<sf:hidden path="pageSize" />
			 ...
			 <c:if test="${!empty list}">
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="form-group">
							<font color="white"> <sf:label path="login">
									EmailId
									<span style="color: red">*</span>
								</sf:label></font>
							<div class="input-group">
                    ...
                    <thead  style="background-color:  #000066">
                     <tr>
							 <th style="text-align: center;color: white;"><input type="checkbox" id = "select_all" >Select All</th> 
								...
								<th style="text-align: center; color: white;">FirstName</th>
								<th style="text-align: center; color: white;">LastName</th>
								<th style="text-align: center; color: white;">Address</th>
								<th style="text-align: center; color: white;">Dob</th>
								<th style="text-align: center; color: white;">EmailId</th>
							 ...
							 <c:forEach items="${list}" var="user" varStatus="ct">
								 <tr>
									...
									<td style="text-align: center; color: white">${user.firstName}</td>
									<td style="text-align: center; color: white">${user.lastName}</td>
									<td style="text-align: center; color: white">${user.address}</td>
									
									
									<td style="text-align: center; color: white"><fmt:formatDate
											value="${user.dob}" type="date" pattern="dd-MM-yyyy" /></td>
									<td style="text-align: center; color: white">${user.login}</td>
					             <td style="text-align: center;color: white">
	                               <c:url var="editUrl" value="/ctl/User/AddUser?id=" />				
                       
	      <a style="color: white" href="${editUrl}${user.id}"><i class="fa fa-edit"></i></a>
